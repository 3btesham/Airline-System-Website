...
def search_flights():
    if request.method == 'GET':
        ...
        return render_template('customer_dashboard.html', customer = user_data[0], spendings = user_spending[0],future_flights=future_flights, found_flight=found_flight)
...
def spending_range():
    # try:
        ...
        return render_template('customer_dashboard.html', customer = user_data[0], start_date=start_date, end_date=end_date, range_spending = range_spending, future_flights=future_flights)
